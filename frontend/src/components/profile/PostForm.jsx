    ...
    <>
        <form className="w-1/3" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
                ...
                <select id="underline_select" name="type" value={formPost.type} onChange={handleChange} class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                    <option selected>Noticia, beneficio, Oferta Laboral...</option>
